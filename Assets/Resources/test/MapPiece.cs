...
public class MapPiece : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log("ObjectName: " + this.gameObject.name + $"[MapPiece] (0,0) 셀 중심 월드좌표: {cellCenter}, 내 position: {transform.position}, 타일맵 localPosition: {tilemap.transform.localPosition}");
    }
