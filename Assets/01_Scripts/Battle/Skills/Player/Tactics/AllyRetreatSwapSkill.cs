...
[CreateAssetMenu(menuName = "Battle/Skill/Player/Tactics/AllyRetreatSwap")]
public class AllyRetreatSwapSkill : SkillAsset
{
...

    {
        ...
        var units = _battlemanager.Grid.GetUnitsInArea(_map, new[] { _cell });  // BattleManager 유틸 재사용 :contentReference[oaicite:1]{index=1}
