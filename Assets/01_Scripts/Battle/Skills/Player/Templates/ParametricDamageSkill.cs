...
public class ParametricDamageSkill : SkillAsset, IProjectileTileSkill
{
    ...
    [Header("발화 부여 설정")]
    [Tooltip("훈련으로 발화 효과를 적용할 것인지")]
    public bool trainingApplyIgnition = false;
    [Tooltip("발화를 활성화시키는 훈련 루트 인덱스 (-1이면 비활성)")]
    [Range(-1, 2)]
    public int routeForIgnition = -1;
    [Range(1, DebuffTuning.MaxStacks)] public int trainingIgnitionStacks = 1;
    [Min(1)] public int trainingIgnitionDurationTurns = 2;
